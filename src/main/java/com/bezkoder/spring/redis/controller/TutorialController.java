package com.bezkoder.spring.redis.controller;
...
import com.bezkoder.spring.redis.service.TutorialService;
...
public class TutorialController {
  ...
  public ResponseEntity<?>  createTutorial(@RequestBody Tutorial tutorial) {
    try {
      Tutorial _tutorial = tutorialService.save(new Tutorial(tutorial.getTitle(), tutorial.getDescription(), tutorial.isPublished()));
